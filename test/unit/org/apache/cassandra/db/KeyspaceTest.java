...
public class KeyspaceTest extends CQLTester
{
    ...
    {
        Clustering startClustering = new BufferClustering(ByteBufferUtil.bytes(sliceStart));
        Clustering endClustering = new BufferClustering(ByteBufferUtil.bytes(sliceEnd));
