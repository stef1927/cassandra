...
public class RangeAwareSSTableWriter implements SSTableMultiWriter
{
    ...
    public RangeAwareSSTableWriter(ColumnFamilyStore cfs, long estimatedKeys, long repairedAt, SSTableFormat.Type format, int sstableLevel, long totalSize, SSTableTracker sstableTracker, SerializationHeader header) throws IOException
    {
        ...
        if (boundaries == null)
        {
            ...
            currentWriter = cfs.createSSTableMultiWriter(desc, estimatedKeys, repairedAt, sstableLevel, header, sstableTracker);
        }
    }
