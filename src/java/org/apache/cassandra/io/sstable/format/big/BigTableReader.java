...
import org.apache.cassandra.io.sstable.format.SSTableReadsListener.Reason;
...
public class BigTableReader extends SSTableReader
{
                                        ...
                                        SSTableReadsListener listener)
    {
        if (op == Operator.EQ)
        {
            ...
            {
                listener.skippingSSTable(this, Reason.BLOOM_FILTER);
        ...
        if (skip)
        {
            ...
            listener.skippingSSTable(this, Reason.MIN_MAX_KEYS);
        ...
        try (FileDataInput in = ifile.createReader(sampledPosition))
        {
            ...
            while (!in.isEOF())
            {
                ...
                else
                {
                    ...
                    if (v < 0)
                    {
                        listener.skippingSSTable(this, Reason.PARTITION_INDEX_LOOKUP);
                ...
                if (opSatisfied)
                {
                    ...
                    listener.indexEntryFound(this, indexEntry);
        ...
        if (op == SSTableReader.Operator.EQ && updateCacheAndStats)
            bloomFilterTracker.addFalsePositive();
        listener.skippingSSTable(this, Reason.INDEX_ENTRY_NOT_FOUND);
