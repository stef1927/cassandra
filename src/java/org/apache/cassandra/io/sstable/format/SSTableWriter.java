...
public abstract class SSTableWriter extends SSTable implements Transactional
{
                                       ...
                                       SSTableTracker sstableTracker)
    {
        ...
        return writerFactory.open(descriptor, keyCount, repairedAt, metadata, metadataCollector, header, observers(descriptor, indexes, sstableTracker.opType()), sstableTracker);
    }
                                       ...
                                       SSTableTracker sstableTracker)
    {
        ...
        return create(metadata, descriptor, keyCount, repairedAt, sstableLevel, header, indexes, sstableTracker);
    }
                                       ...
                                       SSTableTracker sstableTracker)
    {
        ...
        return create(descriptor, keyCount, repairedAt, metadata, collector, header, indexes, sstableTracker);
    }
    ...
    public static SSTableWriter create(String filename,
                                       ...
                                       SSTableTracker sstableTracker)
    {
        return create(Descriptor.fromFilename(filename), keyCount, repairedAt, sstableLevel, header, indexes, sstableTracker);
    }
                                       ...
                                       SSTableTracker sstableTracker)
    {
        ...
        return create(descriptor, keyCount, repairedAt, 0, header, indexes, sstableTracker);
    }
