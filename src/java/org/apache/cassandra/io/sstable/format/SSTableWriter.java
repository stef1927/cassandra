...
public abstract class SSTableWriter extends SSTable
{
    ...
    public static SSTableWriter create(Descriptor descriptor, long keyCount, long repairedAt, int sstableLevel)
    {
        ...
        return create(metadata, descriptor, keyCount, repairedAt, sstableLevel);
    }

    public static SSTableWriter create(CFMetaData metadata, Descriptor descriptor, long keyCount, long repairedAt, int sstableLevel)
    {
