...
public class SimpleSSTableMultiWriter implements SSTableMultiWriter
{
    ...
    protected SimpleSSTableMultiWriter(SSTableWriter writer, SSTableTracker sstableTracker)
    {
    ...
    {
        sstableTracker.untrackNew(writer);
    ...
    {
        SSTableWriter writer = SSTableWriter.create(descriptor, keyCount, repairedAt, cfm, metadataCollector, header, indexes, sstableTracker);
        return new SimpleSSTableMultiWriter(writer, sstableTracker);
    }
}
