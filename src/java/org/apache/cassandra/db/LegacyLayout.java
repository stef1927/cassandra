...
public abstract class LegacyLayout
{
    ...
    throws UnknownColumnException
    {
        ...
        if (metadata.isSuper())
        {
            ...
            return decodeForSuperColumn(metadata, new BufferClustering(superColumnName), cellname);
        }
    ...
    public static LegacyCellName decodeCellName(CFMetaData metadata, ByteBuffer cellname, boolean readAllAsDynamic) throws UnknownColumnException
    {
        ...
        if ((def == null) || def.isPrimaryKeyColumn())
        {
            ...
            if (metadata.isCompactTable())
                return new LegacyCellName(new BufferClustering(column), metadata.compactValueColumn(), null);
    ...
    public static Clustering decodeClustering(CFMetaData metadata, ByteBuffer value)
    {
        ...
        return new BufferClustering(components.subList(0, Math.min(csize, components.size())).toArray(new ByteBuffer[csize]));
    }
